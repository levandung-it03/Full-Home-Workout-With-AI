...
export class EnumAdminService {
    ...
    static async getAllGendersEnum() {
        try {
            const res = await springService.get(`${API_PUBLIC_PREFIX}/admin/v1/get-all-genders`);
            return res.data;
        } catch (error) {
            throw error.response ? error.response.data : error;
        }
...
export class EnumUserService {
    ...
    static async getAllGendersEnum() {
        try {
            const res = await springService.get(`${API_PUBLIC_PREFIX}/user/v1/get-all-genders`);
            return res.data;
        } catch (error) {
            throw error.response ? error.response.data : error;
        }
