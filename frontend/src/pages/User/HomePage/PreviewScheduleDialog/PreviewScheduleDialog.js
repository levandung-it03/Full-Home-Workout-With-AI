            ...
            : <>
                <div className="preview-schedule">
                    ...
                    <ul className="information">
                        ...
                        {previewScheduleData.subscription.changingCoinsHistories.changingTimeAsDateObj !== undefined ? <li className="subscribed-time">
                            Subscribed Time:
                            {separateDateTime(previewScheduleData.subscription.changingCoinsHistories.changingTimeAsDateObj)}
