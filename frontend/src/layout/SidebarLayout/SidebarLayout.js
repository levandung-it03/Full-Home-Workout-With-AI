import { CalendarCheck2, CreditCard, Dumbbell, FileText, House, Images, LayoutDashboard, SquareUserRound, TableProperties } from 'lucide-react';
    ...
    return (
        <div className="container" style={sidebarStyles}>
            <UserSidebar>
                ...
                <SidebarItem icon={<CreditCard />} text="Deposit Coins" path='/deposit-coins' />
                <SidebarItem icon={<FileText />} text="Coins Histories" path='/coins-histories' />
            </UserSidebar>
            <div className="content" style={{ flex: 1 }}>
                {children}
            </div>
